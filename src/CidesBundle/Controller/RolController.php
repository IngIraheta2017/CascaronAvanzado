...
class RolController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $rols = $em->getRepository('CidesBundle:Rol')->findAll();
    ...
    {
        $rol = new Rol();
        $form = $this->createForm('CidesBundle\Form\RolType', $rol);
    ...
    {
        $deleteForm = $this->createDeleteForm($rol);
        $editForm = $this->createForm('CidesBundle\Form\RolType', $rol);
